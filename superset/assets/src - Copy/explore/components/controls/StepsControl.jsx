...
class StepsControl extends React.PureComponent {
  ...
  changeFilter(filter, options) {
    // console.log('changeFilter steps', filter, options);
  }

  onChange(id, controlName, obj) {
    // console.log('onChange steps', id, obj);
  ...
  render() {
    ...
    // console.log('datasourceType', this.props.datasourceType)
