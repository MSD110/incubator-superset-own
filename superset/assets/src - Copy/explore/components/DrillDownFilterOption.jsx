...
import DrillDownFilterEditPopover from './DrillDownFilterEditPopover';
...
export default class DrillDownFilterOption extends React.PureComponent {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    const overlay = (
      <DrillDownFilterEditPopover
        onResize={this.onPopoverResize}
        adhocFilter={adhocFilter}
        drillDownFilter={adhocFilter.duplicateWith({})}
...
DrillDownFilterOption.propTypes = propTypes;
